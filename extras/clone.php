...
cloneFileFolder('modules/actesapi'); 

echo "<p>Happy cloning...<br /><br />"; 
echo "Check directory modules/" . $patterns['actesapi'] . " for cloned module <br /></br />"; 
echo "Consider modifying cloned module by editing images/" . $patterns['actesapi'] . "_slogo.png manually (if you care) </p>"; 
