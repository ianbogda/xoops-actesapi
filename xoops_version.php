...
$i++;
$modversion["sub"][$i]["name"] 	= _MI_ACTESAPI_SMNAME2;
$modversion["sub"][$i]["url"] 	= "page2.php";

// Config

$i = 1;
$modversion["config"][$i]["name"]		= "actesapiconf1"; // site name
...
$i++;
$modversion["config"][$i]["name"]		= "actesapiconf2"; // for title page 1
...
//$modversion["config"][$i]["category"]       = "";
$i++;
$modversion["config"][$i]["name"]		= "actesapiconf3"; // meta keywords page 1
...
//$modversion["config"][$i]["category"]       = "";
$i++;
$modversion["config"][$i]["name"]		= "actesapiconf4"; // meta description page 1
$modversion["config"][$i]["title"]			= "_MI_ACTESAPI_CONF4";
$modversion["config"][$i]["description"]	= "_MI_ACTESAPI_CONF4_DESC";
$modversion["config"][$i]["formtype"]		= "textarea";
$modversion["config"][$i]["valuetype"]		= "textarea";
$modversion["config"][$i]["default"]		= _MI_ACTESAPI_CONF4_DEFAULT;
//$modversion["config"][$i]["options"]        = array( );
//$modversion["config"][$i]["category"]       = "";
$i++;
$modversion["config"][$i]["name"]		= "actesapiconf5"; // title page 2
$modversion["config"][$i]["title"]			= "_MI_ACTESAPI_CONF5";
$modversion["config"][$i]["description"]	= "_MI_ACTESAPI_CONF5_DESC";
$modversion["config"][$i]["formtype"]		= "textbox";
$modversion["config"][$i]["valuetype"]		= "text";
$modversion["config"][$i]["default"]		= _MI_ACTESAPI_CONF5_DEFAULT;
//$modversion["config"][$i]["options"]        = array( );
//$modversion["config"][$i]["category"]       = "";
$i++;
$modversion["config"][$i]["name"]		= "actesapiconf6"; // meta keywords page 2
$modversion["config"][$i]["title"]			= "_MI_ACTESAPI_CONF6";
$modversion["config"][$i]["description"]	= "_MI_ACTESAPI_CONF6_DESC";
$modversion["config"][$i]["formtype"]		= "textarea";
$modversion["config"][$i]["valuetype"]		= "textarea";
$modversion["config"][$i]["default"]		= _MI_ACTESAPI_CONF6_DEFAULT;
//$modversion["config"][$i]["options"]        = array( );
//$modversion["config"][$i]["category"]       = "";
$i++;
$modversion["config"][$i]["name"]		= "actesapiconf7"; // meta description page 2
$modversion["config"][$i]["title"]			= "_MI_ACTESAPI_CONF7";
$modversion["config"][$i]["description"]	= "_MI_ACTESAPI_CONF7_DESC";
$modversion["config"][$i]["formtype"]		= "textarea";
$modversion["config"][$i]["valuetype"]		= "textarea";
$modversion["config"][$i]["default"]		= _MI_ACTESAPI_CONF7_DEFAULT;
//$modversion["config"][$i]["options"]        = array( );
//$modversion["config"][$i]["category"]       = "";
...
$modversion["templates"][$i]["description"] 	= _MI_ACTESAPI_MANAGER_EXAMPLE_DESC;
$i++;
...
$modversion["blocks"][$i]["name"]           = _MI_ACTESAPI_BLOCK_NAME1;
$modversion["blocks"][$i]["description"]    = _MI_ACTESAPI_BLOCK_NAME1_DESC;
...
$modversion["blocks"][$i]["name"]           = _MI_ACTESAPI_BLOCK_NAME2;
$modversion["blocks"][$i]["description"]    = _MI_ACTESAPI_BLOCK_NAME2_DESC;
