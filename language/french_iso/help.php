...
define("_AM_ACTESAPI_HELP1" , "<p><strong>Note:</strong> Cette section d'aide à la création d'un module sera actualisée au fur et à mesure des évolutions futures de <span class='bold italic'>\"ActesAPI\"</span>.</p>");
define("_AM_ACTESAPI_HELP2" , "
<h4>Clonage du module</h4>
<p>Le module ActesAPI a été conçu pour rendre son clonage aisé.<br />Pour la procédure ci-dessous, nous considérons que vous travaillez dans un environnement local.</p>
<ol>
	...
	<li>Si vous le désirez, vous pouvez changer l'image <span class='italic'>\"images/nomdumodule_slogo.png\"</span>. Vous avez le fichier au format \"psd\" dans le dossier \"docs\" de ActesAPI</li>
...
");
define("_AM_ACTESAPI_HELP4" , "<h4>Autres documentations</h4>");
